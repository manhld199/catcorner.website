...
// import utils
import { PUBLIC_ADMIN_GROUPS_URL } from "@/utils/constants/urls";
...
const ActionCell = ({ row }: { row: Row<IAdminGroup> | undefined }) => {
  const id = row?.original._id as string;
  const name = row?.original.group_name as string;
    ...
    <DropdownMenu modal={false}>
      ...
      <DropdownMenuContent align="end">
        ...
        <DropdownMenuItem asChild>
          <Link href={`/admin/groups/${id}`} target="_blank">
