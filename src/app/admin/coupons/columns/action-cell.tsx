...
// import utils
import { PUBLIC_ADMIN_COUPONS_URL } from "@/utils/constants/urls";
...
const ActionCell = ({ row }: { row: Row<IAdminCoupon> | undefined }) => {
  const id = row?.original._id as string;
  const name = row?.original.coupon_name as string;
    ...
    <DropdownMenu modal={false}>
      ...
      <DropdownMenuContent align="end">
        ...
        <DropdownMenuItem asChild>
          <Link href={`/admin/coupons/${id}`} target="_blank">
