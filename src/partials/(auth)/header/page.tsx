...
import {
  CustomerHeaderLogo,
} from "@/partials/(customer)/header/components";
...
interface AuthHeaderProps {
  ...
  return (
    <header className="bg-white dark:bg-black shadow-sm w-[80%] mx-auto bg-white">
      <div className="flex justify-between items-center py-2">
        ...
        <div className="flex gap-4">
          <Link href="/login">
            <Button variant={currentPage === 'login' ? "filled" : "filled_outlined"}>Đăng nhập</Button>
          </Link>
          <Link href="/register">
            <Button variant={currentPage === 'register' ? "filled" : "filled_outlined"}>Đăng ký</Button>
          </Link>
        </div>
